...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/uvm_custom_install_verdi_recording_t8TSlc \
    VCS_PARTCOMP_LIB.pc_uvm_custom_install_verdi_recording_config \
    -o partitionlib/uvm_custom_install_verdi_recording_t8TSlc/libvcspc_uvm_custom_install_verdi_recording_t8TSlc.so \
    -Mdir=partitionlib/uvm_custom_install_verdi_recording_t8TSlc/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/uvm_custom_install_verdi_recording_t8TSlc/uvm_custom_install_verdi_recording_t8TSlc.log \
