...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/_vcs_msglog_o6N9xb \
    VCS_PARTCOMP_LIB.pc__vcs_msglog_config \
    -o partitionlib/_vcs_msglog_o6N9xb/libvcspc__vcs_msglog_o6N9xb.so \
    -Mdir=partitionlib/_vcs_msglog_o6N9xb/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/_vcs_msglog_o6N9xb/_vcs_msglog_o6N9xb.log \
