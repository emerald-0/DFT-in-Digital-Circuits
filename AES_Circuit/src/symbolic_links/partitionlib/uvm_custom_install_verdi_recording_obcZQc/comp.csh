...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/uvm_custom_install_verdi_recording_obcZQc \
    VCS_PARTCOMP_LIB.pc_uvm_custom_install_verdi_recording_config \
    -o partitionlib/uvm_custom_install_verdi_recording_obcZQc/libvcspc_uvm_custom_install_verdi_recording_obcZQc.so \
    -Mdir=partitionlib/uvm_custom_install_verdi_recording_obcZQc/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/uvm_custom_install_verdi_recording_obcZQc/uvm_custom_install_verdi_recording_obcZQc.log \
