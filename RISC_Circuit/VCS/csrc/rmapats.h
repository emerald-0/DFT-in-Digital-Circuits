...
extern "C" {
#endif
void  hs_0_M_0_21__RSIC_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_0__RSIC_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_0_1__RSIC_2_daidir (UB  * pcode, scalar  val, U  I609, scalar  * I1406, U  did);
void  hs_0_M_0_2__RSIC_2_daidir (UB  * pcode);
void  hs_0_M_0_5__RSIC_2_daidir (UB  * pcode, UB  val);
void  hs_0_M_1_21__RSIC_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_0__RSIC_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_1_1__RSIC_2_daidir (UB  * pcode, scalar  val, U  I609, scalar  * I1406, U  did);
void  hs_0_M_1_2__RSIC_2_daidir (UB  * pcode);
void  hs_0_M_1_5__RSIC_2_daidir (UB  * pcode, UB  val);
void  hs_0_M_2_21__RSIC_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_0__RSIC_2_daidir (UB  * pcode, scalar  val);
void  hs_0_M_2_1__RSIC_2_daidir (UB  * pcode, scalar  val, U  I609, scalar  * I1406, U  did);
void  hs_0_M_2_2__RSIC_2_daidir (UB  * pcode);
void  hs_0_M_2_5__RSIC_2_daidir (UB  * pcode, UB  val);
