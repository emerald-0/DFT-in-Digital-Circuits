...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/uvm_custom_install_verdi_recording_ya0YPc \
    VCS_PARTCOMP_LIB.pc_uvm_custom_install_verdi_recording_config \
    -o partitionlib/uvm_custom_install_verdi_recording_ya0YPc/libvcspc_uvm_custom_install_verdi_recording_ya0YPc.so \
    -Mdir=partitionlib/uvm_custom_install_verdi_recording_ya0YPc/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/uvm_custom_install_verdi_recording_ya0YPc/uvm_custom_install_verdi_recording_ya0YPc.log \
