...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/Risc_16_bit_g2J7Bb \
    VCS_PARTCOMP_LIB.pc_Risc_16_bit_config \
    -o partitionlib/Risc_16_bit_g2J7Bb/libvcspc_Risc_16_bit_g2J7Bb.so \
    -Mdir=partitionlib/Risc_16_bit_g2J7Bb/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/Risc_16_bit_g2J7Bb/Risc_16_bit_g2J7Bb.log \
