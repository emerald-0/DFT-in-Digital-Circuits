...
cd /home/vlsilab/sagar_harsh_soham/RISC/symbolic_links
...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/uvm_custom_install_verdi_recording_Y2ADNb \
    VCS_PARTCOMP_LIB.pc_uvm_custom_install_verdi_recording_config \
    -o partitionlib/uvm_custom_install_verdi_recording_Y2ADNb/libvcspc_uvm_custom_install_verdi_recording_Y2ADNb.so \
    -Mdir=partitionlib/uvm_custom_install_verdi_recording_Y2ADNb/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/uvm_custom_install_verdi_recording_Y2ADNb/uvm_custom_install_verdi_recording_Y2ADNb.log \
