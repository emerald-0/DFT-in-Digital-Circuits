...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/_vcs_msglog_YUfb4c \
    VCS_PARTCOMP_LIB.pc__vcs_msglog_config \
    -o partitionlib/_vcs_msglog_YUfb4c/libvcspc__vcs_msglog_YUfb4c.so \
    -Mdir=partitionlib/_vcs_msglog_YUfb4c/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/_vcs_msglog_YUfb4c/_vcs_msglog_YUfb4c.log \
