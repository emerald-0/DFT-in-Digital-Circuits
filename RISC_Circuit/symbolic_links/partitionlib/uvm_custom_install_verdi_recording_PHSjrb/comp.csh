...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/uvm_custom_install_verdi_recording_PHSjrb \
    VCS_PARTCOMP_LIB.pc_uvm_custom_install_verdi_recording_config \
    -o partitionlib/uvm_custom_install_verdi_recording_PHSjrb/libvcspc_uvm_custom_install_verdi_recording_PHSjrb.so \
    -Mdir=partitionlib/uvm_custom_install_verdi_recording_PHSjrb/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/uvm_custom_install_verdi_recording_PHSjrb/uvm_custom_install_verdi_recording_PHSjrb.log \
