...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/_vcs_pc_package__xmMLv \
    VCS_PARTCOMP_LIB.pc__vcs_pc_package__config \
    -o partitionlib/_vcs_pc_package__xmMLv/libvcspc__vcs_pc_package__xmMLv.so \
    -Mdir=partitionlib/_vcs_pc_package__xmMLv/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/_vcs_pc_package__xmMLv/_vcs_pc_package__xmMLv.log \
