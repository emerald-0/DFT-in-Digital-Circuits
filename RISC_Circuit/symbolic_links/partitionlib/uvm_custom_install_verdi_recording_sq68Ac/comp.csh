...
${VCS_HOME}/bin/vcs $* \
    ...
    -q \
    -partcomp=so \
    -partcomp_so_dir=partitionlib/uvm_custom_install_verdi_recording_sq68Ac \
    VCS_PARTCOMP_LIB.pc_uvm_custom_install_verdi_recording_config \
    -o partitionlib/uvm_custom_install_verdi_recording_sq68Ac/libvcspc_uvm_custom_install_verdi_recording_sq68Ac.so \
    -Mdir=partitionlib/uvm_custom_install_verdi_recording_sq68Ac/csrc \
    -Xarijit=0x2 \
    -sverilog \
    -l partitionlib/uvm_custom_install_verdi_recording_sq68Ac/uvm_custom_install_verdi_recording_sq68Ac.log \
